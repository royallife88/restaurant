...
@section('title', __('lang.send_sms'))

@section('content_header')
    <h1>@lang('lang.send_sms')</h1>
@stop
...
@section('main_content')
    ...
    {!! Form::open(['url' => action('Admin\SmsController@store'), 'method' => 'post', 'files' => true, 'id' => 'sms_form']) !!}

    <x-adminlte-card title="{{ __('lang.send_sms') }}" theme="{{ config('adminlte.right_sidebar_theme') }}"
