        ...
        <div class="flex flex-row">
            <div class="w-3/4 text-right">
                <div class="flex-col mt-6">
                    ...
                    <div class="pr-4 pt-2 font-semibold text-base text-white">
                    ...
                    <div class="pr-4 pt-2 mt-8">
                        <a href="{{ action('AboutUsController@index') }}"
                            class="bg-red text-white font-bold px-4 py-2 border-2 border-white rounded-lg">@lang('lang.show_more')
                        </a>
                    </div>
                </div>
            </div>
