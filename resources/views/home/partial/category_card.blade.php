<a href="{{ action('ProductController@getProductListByCategory', $category->id) }}" class="w-full h-0 shadow-lg pb-full rounded-xl bg-center bg-no-repeat bg-cover relative border-2 border-dark mb:mb-8 xs:mb-16"
    ...
    <div class="flex absolute md:-bottom-16 xs:-bottom-10 w-full">
        <div class="lg:h-10 md:h-8 xs:h-6 md:w-48 xs:w-32 bg-darkblue mx-auto text-center rounded-3xl">
