<a href="{{ action('ProductController@getProductListByCategory', $category->id) }}" class="w-full h-0 shadow-lg pb-full rounded-xl bg-center bg-no-repeat bg-cover relative mb:mb-8 xs:mb-16"
