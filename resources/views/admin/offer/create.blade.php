...
{!! Form::open(['url' => action('Admin\OfferController@store'), 'method' => 'post', 'files' => true, 'id' =>
'offer_form']) !!}
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                {!! Form::select('product_class_id', $categories, false, ['class' => 'select2
                form-control', 'id' =>
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                {!! Form::select('product_ids[]', $products, false, ['class' => 'select2
