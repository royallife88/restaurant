<div x-data="{ iconOpen: false }" class="relative">
    ...
    <div x-show="iconOpen" x-transition x-transition.duration.500ms x-transition:leave.duration.400ms
        ...
        @if (!empty(App\Models\System::getProperty('instagram')))
            <a target="_blank"
                href="https://instagram.com/send?phone={{ App\Models\System::getProperty('instagram') }}"
                class="">
                <img src="{{ asset('images/instagram.png') }}" alt="instagram" class=" w-6 h-6 mr-2 ">
            </a>
        @endif
        @if (!empty(App\Models\System::getProperty('twitter')))
        ...
        @endif
        @if (!empty(App\Models\System::getProperty('youtube')))
        ...
        @endif
        @if (!empty(App\Models\System::getProperty('telegram')))
        ...
        @endif
        @if (!empty(App\Models\System::getProperty('whatsapp')))
            <a target="_blank"
        ...
        @endif
        @if (!empty(App\Models\System::getProperty('facebook')))
