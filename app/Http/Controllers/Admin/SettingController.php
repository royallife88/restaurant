...
class SettingController extends Controller
{
    ...
    public function saveSystemSettings(Request $request)
    {
        ...
        System::updateOrCreate(
            ['key' => 'email'],
            ['value' => $request->email, 'date_and_time' => Carbon::now(), 'created_by' => Auth::user()->id]
        );
        System::updateOrCreate(
            ['key' => 'open_time'],
        ...
        if ($request->hasFile('home_background_image')) {
            $data['home_background_image'] = $this->commonUtil->ImageResizeAndUpload($request->home_background_image, 'uploads', 1350, 450);
        }
        ...
        if ($request->hasFile('page_background_image')) {
            $data['page_background_image'] = $this->commonUtil->ImageResizeAndUpload($request->page_background_image, 'uploads', 1350, 900);
        }
